 ...
 *
 * This annotation can be applied to servlet handler methods to specify
 * logging behavior. It provides options to customize logging settings for
 * both request and response data, as well as control the logging level.
 *
 * @property loggingLevel Specifies the logging level to be used.
 * @property requestSettings Configures the logging behavior for HTTP
 *    requests, such as whether sensor information, headers, URI, and body
 *    information should be included.
 * @property responseSettings Configures the logging behavior for HTTP
 *    responses, similar to request settings.
 */
