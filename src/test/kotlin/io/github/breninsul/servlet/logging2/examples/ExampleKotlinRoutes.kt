...
class ExampleKotlinRoutes {
    ...
    fun exampleAttributesBuilderRouteKotlin(): RouterFunction<ServerResponse> {
        return RouterFunctions
            ...
            .loggingRequestMaskBodyKeys(mapOf(JsonBodyType to listOf("yourJsonPropertyNameToMask", "password"), FormBodyType to listOf("yourFormFieldyNameToMask", "authorisation")))
            .loggingResponseMaskBodyKeys(mapOf(JsonBodyType to listOf("yourJsonPropertyNameToMask", "password"), FormBodyType to listOf("yourFormFieldyNameToMask", "authorisation")))
            .build()
    }
